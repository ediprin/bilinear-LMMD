...
DEFAULTS: dict[str, Any] = {
    ...
    "model": {
        ...
        "mde_branch_channels": 16,
        "mde_control_hidden_dim": 287,
        "moe_local_dim": 256,
        "moe_gate_hidden": 32,
        "moe_hbp_prior": 0.8,
        "dual_gate_hidden": 32,
        "dual_fusion_detach": True,
        "multistage_fusion_dim": 128,
        "multistage_target_stage": 1,
        "multistage_gate_hidden": 96,
        "dropout": 0.2,
        "classifier": "linear",
        "arcface_scale": 30.0,
        "arcface_margin": 0.3,
        "arpl_weight": 0.1,
        "arpl_margin": 1.0,
        "dsconv_enabled": False,
        "dsconv_bits": 4,
        "dsconv_block_size": 128,
        "dsconv_stage_prefixes": ["blocks.0", "blocks.1", "blocks.2"],
    ...
    "training": {
        ...
        "ema_decay": 0.0,
        "ema_start_epoch": 0,
        "slow_start_lr_epochs": 0,
        "slow_start_lr_factor": 0.1,
